...
The many transmitters, receptors, synaptic actions, and drugs met across this section are gathered in Table~\ref{tab:transmitters} below, which reads as a single-glance reference to everything discussed above.

{\footnotesize
\renewcommand{\arraystretch}{1.3}
\begin{longtable}{p{2.8cm} p{2.4cm} p{1.8cm} p{1.9cm} p{4.0cm}}
\caption{Neurotransmitters, their receptors, synaptic actions, and the drugs that act at them, as discussed in this section. ``Type'' distinguishes fast ionotropic channels from slower metabotropic G protein-coupled receptors (GPCRs), with the G protein noted where the text gave it. A dash marks a receptor for which no drug was discussed here.}
...
\midrule
Dopamine & D2 & GPCR (G\textsubscript{i}) & Inhibitory & --- (autoreceptor) \\
\midrule
...
\midrule
Noradrenaline & $\alpha$\textsubscript{2} & GPCR & Inhibitory & --- (autoreceptor) \\
\midrule
