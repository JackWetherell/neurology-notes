...
Damage to V1 produces \textbf{visual field defects}, with the pattern dictated precisely by the retinotopic map and the anatomy of the pathway feeding into it. A complete unilateral lesion of V1 produces a \textbf{contralateral homonymous hemianopia}: a loss of the entire opposite half of the visual field in both eyes. Smaller lesions produce smaller defects: damage to the upper bank of the calcarine sulcus produces a \textit{lower} contralateral quadrantanopia, damage to the lower bank produces an \textit{upper} contralateral quadrantanopia (the latter often called a ``pie in the sky'' defect when produced by temporal-lobe lesions interrupting Meyer's loop). Damage that spares the occipital pole leaves the macula relatively unaffected, producing the curious phenomenon of \textbf{macular sparing}, in which a hemianopic patient retains a small island of central vision on the affected side. Bilateral V1 damage, mercifully rare, produces \textbf{cortical blindness}: the patient cannot see despite intact eyes, intact optic nerves, and intact thalamus.
...
\subsubsection{Re-representation in the Anterior Insula}
...
\subsection{Clinical Picture}

Insular damage tends not to produce the dramatic, clean syndromes of frontal or temporal damage; the insula is too multifunctional and too well connected for that. What it produces instead is a constellation of subtler deficits that, taken together, can be quite striking. Patients with insular strokes may show \textbf{ageusia}, distortions of taste and smell, blunted disgust and empathy, altered awareness of internal bodily states (such as failing to notice a full bladder or a racing heart), and, importantly, \textbf{autonomic dysregulation}, with a measurable increased risk of cardiac complications after right insular stroke in particular.

In epilepsy, seizures originating in the insula are notorious for being difficult to recognise, because they can mimic seizures from any of the surrounding lobes, producing visceral sensations, taste hallucinations, fear, breathlessness, or laryngeal constriction depending on which patch of insula is involved. The insula's variety is, in clinical settings, often as much a hindrance as it is a feature.
