...
A few recur throughout what follows:
...
\begin{itemize}
    ...
    \item \textbf{Acetylcholine} does two quite separate jobs. In the periphery it is the transmitter of the neuromuscular junction, where it activates skeletal muscle directly. In the brain it is a modulator, strongly implicated in attention and in the formation of memory.
